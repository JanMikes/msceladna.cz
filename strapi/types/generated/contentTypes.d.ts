...
export interface ApiCooperatingInstitutionCooperatingInstitution
  extends Struct.CollectionTypeSchema {
  collectionName: 'cooperating_institutions';
  info: {
    displayName: 'Spolupracuj\u00EDc\u00ED pracovi\u0161t\u011B';
    pluralName: 'cooperating-institutions';
    singularName: 'cooperating-institution';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::cooperating-institution.cooperating-institution'
    > &
      Schema.Attribute.Private;
...
export interface ApiEmployeeEmployee extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['vedeni', 'pedagogicky', 'provozni']
    >;
    courses: Schema.Attribute.RichText;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    email: Schema.Attribute.Email;
...
export interface ApiNavigationNavigation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    children: Schema.Attribute.Component<'elements.nav-item', true>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiNewsArticleNewsArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<['aktualita', 'reportaz']> &
      Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiOrganizationOrganization extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    dataBox: Schema.Attribute.String;
    email: Schema.Attribute.Email;
    founder: Schema.Attribute.String;
    founderUrl: Schema.Attribute.String;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    phoneAdmin: Schema.Attribute.String;
    phoneManagement: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    description: Schema.Attribute.RichText;
    financialAmount: Schema.Attribute.String;
...
export interface ApiWorkplaceWorkplace extends Struct.CollectionTypeSchema {
  collectionName: 'workplaces';
  info: {
    displayName: 'Pracovi\u0161t\u011B';
  ...
  attributes: {
    address: Schema.Attribute.String;
    childrenCapacity: Schema.Attribute.Integer;
    classCount: Schema.Attribute.Integer;
    content: Schema.Attribute.DynamicZone<
      [
        'components.text',
        'components.heading',
    ...
    description: Schema.Attribute.RichText;
    email: Schema.Attribute.Email;
    gardenDescription: Schema.Attribute.RichText;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::workplace.workplace'
    ...
    name: Schema.Attribute.String & Schema.Attribute.Required;
    phone: Schema.Attribute.String;
    programType: Schema.Attribute.Enumeration<['zacit_spolu', 'bezna_ms']>;
    publishedAt: Schema.Attribute.DateTime;
    sidebar: Schema.Attribute.DynamicZone<
      [
        'components.text',
    ...
    >;
    slug: Schema.Attribute.UID<'name'> & Schema.Attribute.Required;
    specifics: Schema.Attribute.RichText;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::cooperating-institution.cooperating-institution': ApiCooperatingInstitutionCooperatingInstitution;
